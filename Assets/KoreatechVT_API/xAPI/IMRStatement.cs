...
namespace IMR
{
    public class IMRStatement
    {
        ...
        public virtual void SetActor()
        {
            ...
            var actormbox = XAPIApplication.current.ActorMboxName;
            _actor.mbox = "mailto:" + actormbox;
            _actor.name = actor;
        ...
        {
            _verb.id = new Uri(Lesson.BASE_URL + "/" + verb.Replace(" ", ""));
        ...
        {
            _activity.id = new Uri(Lesson.BASE_URL + "/" + activity.Replace(" ", "")).ToString();
