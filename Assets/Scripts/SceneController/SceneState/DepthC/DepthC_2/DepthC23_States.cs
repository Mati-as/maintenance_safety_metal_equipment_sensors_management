...
public class DepthC23_State_3 : Base_SceneState
{
    ...
    {
        CurrentScene.SetHighlightIgnore((int)DepthC2_GameObj.PowerHandle);
        base.OnExit();
    }
}
...
public class DepthC23_State_4 : Base_SceneState
{
    ...
    public override void OnExit()
    {
        CurrentScene.SetHighlightIgnore((int)DepthC2_GameObj.TankValve);
...
public class DepthC23_State_6 : Base_SceneState
{
    ...
    public override void OnExit()
    {
        ...
        _depthC2SceneController.ToggleActiveState(
            _depthC2SceneController.GetObject((int)DepthC2_GameObj.ElectricScrewdriver),
...
public class DepthC23_State_7 : Base_SceneState
{
    ...
    public override void OnEnter()
    {
        ...
        _depthC2SceneController.animatorMap[(int)DepthC2_GameObj.TS_InnerScrewA]
            .SetBool(DepthC2_SceneController.UNWIND, true);
        _depthC2SceneController.animatorMap[(int)DepthC2_GameObj.TS_InnerScrewB]
            .SetBool(DepthC2_SceneController.UNWIND, true);
        _depthC2SceneController.animatorMap[(int)DepthC2_GameObj.TS_InnerScrewC]
            .SetBool(DepthC2_SceneController.UNWIND, true);
        ...
        _depthC2SceneController.animatorMap[(int)DepthC2_GameObj.Probe_Anode]
            .SetBool(DepthC2_SceneController.PROBE_TO_SCREWB, false);
        _depthC2SceneController.animatorMap[(int)DepthC2_GameObj.Probe_Cathode]
            .SetBool(DepthC2_SceneController.PROBE_TO_SCREWB, false);
...
public class DepthC23_State_10 : Base_SceneState
{
    ...
    public override void OnEnter()
    {
        ...
        CurrentScene.SetHighlightIgnore((int)DepthC2_GameObj.TS_GroundingTerminalA);
...
public class DepthC23_State_14 : Base_SceneState
{
    ...
    public override void OnEnter()
    {
        Managers.Scene.LoadScene(SceneType.DepthC3);
