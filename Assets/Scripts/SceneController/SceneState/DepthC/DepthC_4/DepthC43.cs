...
public class DepthC43_State_25 : Base_SceneState
{
    private DepthC4_SceneController _depthC4SceneController;
    public DepthC43_State_25(DepthC4_SceneController currentScene) : base(currentScene)
    {
        _depthC4SceneController = currentScene;
    }
    ...
    public override void OnEnter()
    {
        Managers.Scene.LoadScene(SceneType.DepthC5);
    }
    public override void OnStep(){base.OnStep();}
