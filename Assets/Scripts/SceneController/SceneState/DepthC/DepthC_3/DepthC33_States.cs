...
public class DepthC33_State_25 : Base_SceneState
{
    private DepthC3_SceneController _depthC3SceneController;
    public DepthC33_State_25(DepthC3_SceneController currentScene) : base(currentScene)
    {
        _depthC3SceneController = currentScene;
    }
    ...
    public override void OnEnter()
    {
        Managers.Scene.LoadScene(SceneType.DepthC4);
        base.OnEnter();
