...
public class DepthC23_State_1 : Base_SceneState
{
    ...
    private readonly Depth1C_SceneController Depth1C_sceneController;
...
public class DepthC23_State_5 : Base_SceneState
{
    ...
    public override void OnEnter()
    {
        ...
        Depth1C_sceneController.SetUnscrewStatus(false);
        base.OnEnter();
    }
...
public class DepthC23_State_6 : Base_SceneState
{
    ...
    public override void OnExit()
    {
        ...
        Depth1C_sceneController.ToggleActiveState(
            Depth1C_sceneController.GetObject((int)DepthC_GameObj.ElectricScrewdriver),
            Depth1C_sceneController.isDriverOn);
        base.OnExit();
    }
}
...
public class DepthC23_State_7 : Base_SceneState
{
    ...
    public override void OnEnter()
    {
        ...
        Depth1C_sceneController.animatorMap[(int)DepthC_GameObj.TS_InnerScrewA]
            .SetBool(Depth1C_SceneController.UNWIND, true);
        Depth1C_sceneController.animatorMap[(int)DepthC_GameObj.TS_InnerScrewB]
            .SetBool(Depth1C_SceneController.UNWIND, true);
        Depth1C_sceneController.animatorMap[(int)DepthC_GameObj.TS_InnerScrewC]
            .SetBool(Depth1C_SceneController.UNWIND, true);
...
public class DepthC23_State_8 : Base_SceneState
{
    ...
    public override void OnEnter()
    {
        ...
        Depth1C_sceneController.SetScrewDriverSection(false);
...
public class DepthC23_State_12 : Base_SceneState
{
    ...
    public override void OnEnter()
    {
        ...
        Depth1C_sceneController.ToggleActiveState(Depth1C_sceneController.GetObject((int)DepthC_GameObj.ElectricScrewdriver),
            Depth1C_sceneController.isDriverOn);
...
{
    private Depth1C_SceneController Depth1C_sceneController;
