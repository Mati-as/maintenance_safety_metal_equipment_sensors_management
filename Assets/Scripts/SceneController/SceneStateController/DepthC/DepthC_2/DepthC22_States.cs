...
public class DepthC22_State_1 : Base_SceneState
{
    ...
    public override void OnEnter()
    {
        ...
        _depthC2SceneController.GetObject((int)DepthC_GameObj.Indicator).GetComponent<IndicatorController>().ShowErrorMessage();
...
public class DepthC22_State_9 : Base_SceneState
{
    ...
    public override void OnEnter()
    {
        ...
        _depthC2SceneController.animatorMap[(int)DepthC_GameObj.TS_InnerScrewA].Update(1);
        _depthC2SceneController.animatorMap[(int)DepthC_GameObj.TS_InnerScrewB].Update(1);
        _depthC2SceneController.animatorMap[(int)DepthC_GameObj.TS_InnerScrewC].Update(1);
...
{DepthC2_SceneController _depthC2SceneController;
    ...
    {   
        ...
        _depthC2SceneController.ToggleActiveState(_depthC2SceneController.
            GetObject((int)DepthC_GameObj.ElectricScrewdriver), _depthC2SceneController.isDriverOn);
