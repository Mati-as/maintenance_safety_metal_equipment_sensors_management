...
public class DepthC43_State_3 : Base_SceneState
{
    ...
    public DepthC43_State_3(DepthC4_SceneController currentScene) : base(currentScene) {_depthC3SceneController = currentScene;}
...
{
    private readonly DepthC4_SceneController _depthC3SceneController;
    public DepthC43_State_4(DepthC4_SceneController currentScene) : base(currentScene) {_depthC3SceneController = currentScene;}
