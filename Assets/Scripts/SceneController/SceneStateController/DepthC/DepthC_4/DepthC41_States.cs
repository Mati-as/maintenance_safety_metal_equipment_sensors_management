...
public class DepthC41_State_1 : Base_SceneState
{
    ...
    public override void OnEnter()
    {
        ...
        _depthC3SceneController.DepthC41Init();
...
public class DepthC41_State_3 : Base_SceneState
{
    ...
    public DepthC41_State_3(DepthC4_SceneController currentScene) : base(currentScene) {_depthC3SceneController = currentScene;}
...
{
    private readonly DepthC4_SceneController _depthC3SceneController;
    public DepthC41_State_4(DepthC4_SceneController currentScene) : base(currentScene) {_depthC3SceneController = currentScene;}
